...
void nfc_worker_emulate_mifare_classic(NfcWorker* nfc_worker) {
    ...
    uint8_t first[] = {0x04, 0x77, 0x70, 0x2A, 0x23, 0x4F, 0x80, 0x08, 0x44, 0x00, 0x12, 0x01, 0x11, 0x00, 0x27, 0x16};
    memcpy(emulator.data.block[0].value, first, MF_CLASSIC_BLOCK_SIZE);
    FuriHalNfcTxRxContext tx_rx;
